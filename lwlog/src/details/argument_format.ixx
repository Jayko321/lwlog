export module argument_format;

import std;

namespace lwlog::details
{
	export using format_args_list = std::initializer_list<const char*>;
	...
	export std::string format_args(std::string_view format, format_args_list args)
	{
